...
const FeedbackPanel: React.FC = () => {
  ...
  return (
    <div className="flex-1 flex flex-col bg-mint-light font-inter h-full w-full">
      <div className="p-4 flex-1 flex flex-col"> {/* Added padding here */}
        <form onSubmit={handleSubmit} className="flex-1 flex flex-col space-y-3">
          ...
          <label className="block flex-1 flex flex-col">
            ...
            <textarea
              ...
              className="w-full flex-1 rounded-md border border-mint px-2 py-1 text-sm outline-none focus:ring-2 focus:ring-mint bg-white min-h-[100px]"
        ...
        <button
          ...
          className="w-full rounded-md bg-brand-light py-2 text-text font-semibold hover:bg-brand-dark mt-4"
        >
          Submit Feedback
        </button>
      </div>
